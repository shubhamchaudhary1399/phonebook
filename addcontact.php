		...
		<div class="card" style="max-width: 600px; margin: auto;">
            ...
            <div class="card-body">
            	<div>
            		...
            		<h4 style="width: 70%;float: right;">Add new Contact</h4>
            	</div>
            	
                <form method="POST" action="addcontact_script.php">
                ...
                <div class="form-group">
                    ...
                    <input id="dob" type="date" class="form-control " name="DOB" value="" required autocomplete="dob" autofocus>
                </div>
                <div class="form-group">
                    <label for="mob" class="col-form-label text-md-right">Mobile Number
                     </label>
                    <input id="mob" type="tel" class="form-control " name="Mob" value="" required autocomplete="mob" autofocus>
                </div>
                <div class="form-group">
