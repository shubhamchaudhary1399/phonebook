...
<body>
	<div class="container py-4">
      ...
      $search = mysqli_real_escape_string($con, $search);
			...
			$query = "SELECT contacts.id AS id, contacts.name AS name, contacts.dob AS dob, contacts.contact AS contact, contacts.email AS email FROM contacts WHERE name LIKE '%$search%' OR contact LIKE '%$search%' OR email LIKE '%$search%' LIMIT $start_from, $limit";
			...
			if (mysqli_num_rows($result) >= 1){
				...
				echo "<center><h2>Oops no result found Need Help?</h2></center>";
			}
